export const headerLinks = [
 ...
 export const introduction = "Hello, my name is Shahid, I am a";
 export const jobTitle="Software Developer";
 export const appTitle = "MalikShahid";
 export const footerBio =
    "I am a Software Developer, primarily working on front-end technologies.";
export const about = [
    {
    ...
    },
    {
      ...
      paths. I've been fortunate to contribute my skills and ideas to a dynamic team, helping
